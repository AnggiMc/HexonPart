  ...
  <div class="flex">
   ...
   <div class="w-4/5 p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <h1 class="text-2xl font-bold mx-auto">Payment</h1>
    ...
    <div class="flex justify-center mb-6">
        <div class="relative">
            <input class="pl-10 pr-4 py-2 border rounded w-64" name="cari" id="cari" placeholder="Cari Payment" type="text"/>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                <tr class="border-b text-left">
                    ...
                    <th class="py-2 px-4">Bank INI</th>
                    <th class="py-2 px-4">Active</th>
                    <th class="py-2 px-4">2024-12-14 22:53:54</th>
                    <th class="py-2 px-4">2024-12-14 22:53:54</th>
                    <td class="py-2 px-4">
                        <a class="text-blue-500" href="/admin/edit-payment">
