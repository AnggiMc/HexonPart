  ...
  <div class="flex">
   ...
   <div class="flex-1 p-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <h1 class="text-2xl font-bold">Ubah Banner</h1>
    ...
    <form class="space-y-4" method="" action="">
        ...
        <div class="flex justify-center">
            <button class="bg-gray-300 text-gray-700 px-4 py-2 rounded" name="Ubah" id="Ubah" type="submit">Ubah Banner</button>
        </div>
    </form>
    <!-- Footer -->
    <x-admin-footer>
