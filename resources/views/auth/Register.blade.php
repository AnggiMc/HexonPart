    ...
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg mx-4 sm:mx-0 mt-16 sm:mt-0">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-6 form-input-blur">
                ...
                <input type="text" name="name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-md" placeholder="Masukkan nama Anda" required>
            </div>
            ...
            <div class="mb-6 form-input-blur">
                ...
                <input type="password" name="password_confirmation" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 shadow-md" placeholder="Konfirmasi password Anda" required>
            </div>
